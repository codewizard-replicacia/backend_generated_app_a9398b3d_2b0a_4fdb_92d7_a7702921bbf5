...
public class APINameBuilder implements JPAEdmNameBuilder {
	...
	public String buildEntitySetName(final String entityTypeName) {
    	...
    	eSetName = "Category".equals(entityTypeName) ? "Categories" : defaultNameBuilder.buildEntitySetName(entityTypeName);
    	eSetName = "ShoppingCart".equals(entityTypeName) ? "ShoppingCarts" : defaultNameBuilder.buildEntitySetName(entityTypeName);
